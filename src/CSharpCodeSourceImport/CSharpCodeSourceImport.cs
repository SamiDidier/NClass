...
{
  public class CSharpCodeSourceImport
  {
    // ========================================================================
    // Constants
    ...
    /// <summary>
    /// The main entry point of this class. Imports the source code folder which is given
    /// as the parameter.
    /// </summary>
    /// <param name="fileName">The path of the source code to import.</param>
    /// <returns><c>True</c>, if the import was successful.</returns>
    public bool ImportCodeSource(string folderName)
    {
      /*
    ...
    /// <summary>
    /// The main entry point of this class. Imports the source code filenames which is given
    /// as the parameter.
    /// </summary>
    /// <param name="fileName">The path of the filenames source code to import.</param>
    /// <returns><c>True</c>, if the import was successful.</returns>
    public bool ImportCodeSource(string[] fileNames)
    {
        return true;
    }
