...
namespace NClass.DiagramEditor.ClassDiagram.Connections
{
    internal sealed class Nesting : Connection
    {
        ...
        protected internal override Relationship Relationship { get { return NestingRelationship; } }

        protected override Size StartCapSize { get { return new Size(Diameter, Diameter); } }

        protected override int StartSelectionOffset { get { return Diameter; } }
