...
namespace NClass.AssemblyCSharpImport
{
    public class NETImport
    {
        ...
        public bool ImportAssembly(string fileName)
        {
            ...
            {
                MessageBox.Show(Strings.Error_NoAssembly,
            ...
            try
            {
                ...
                var nrRelationships = relationshipCreator.CreateRelationships(nrAssembly,
            ...
            {
                MessageBox.Show(Strings.Error_BadImageFormat,
                                Strings.Error_MessageBoxTitle,
                                MessageBoxButtons.OK,
                                MessageBoxIcon.Error);
                return false;
