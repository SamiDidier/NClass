...
namespace NClass.Core
{
    public abstract class CompositeType : TypeBase
    {
        ...
        public bool SupportsOperations
        {
            get
            {
                return SupportsMethods || SupportsConstuctors || SupportsDestructors ||
        ...
        public IEnumerable<Field> Fields { get { return FieldList; } }

        public int FieldCount { get { return FieldList.Count; } }

        protected List<Operation> OperationList { get; } = new List<Operation>();

        public IEnumerable<Operation> Operations { get { return OperationList; } }

        public int OperationCount { get { return OperationList.Count; } }

        public int MemberCount { get { return FieldCount + OperationCount; } }

        public IEnumerable<TypeBase> NestedChilds { get { return nestedChilds; } }
