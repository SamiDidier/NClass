...
namespace NClass.Core
{
    public abstract class InterfaceType : CompositeType
    {
        ...
        public sealed override EntityType EntityType { get { return EntityType.Interface; } }

        protected List<InterfaceType> BaseList { get; }

        public IEnumerable<InterfaceType> Bases { get { return BaseList; } }

        public override bool SupportsFields { get { return false; } }

        public override bool SupportsMethods { get { return true; } }

        public override bool SupportsConstuctors { get { return false; } }

        public override bool SupportsDestructors { get { return false; } }

        public override bool SupportsNesting { get { return false; } }

        public override bool HasExplicitBase { get { return BaseList.Count > 0; } }

        public override bool IsAllowedParent { get { return true; } }

        public override bool IsAllowedChild { get { return true; } }
        ...
        public override string Stereotype { get { return "«interface»"; } }
